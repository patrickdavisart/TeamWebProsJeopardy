...
<div>
    <fieldset>
        ...
        <p>This is the name of ninja turtles' favorite food</p><br><br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <label for="SPQ1">Choose your answer:</label><br><br>
            <input type="submit" name="spq1" id="SPQ1" value="What is a Burger?">
            <input type="submit" name="spq1" id="SPQ1" value="What is Pizza?">
            <input type="submit" name="spq1" id="SPQ1" value="What is a Hotdog?">
            <input type="submit" name="spq1" id="SPQ1" value="What is a Sandwich?"><br><br>
        </form>

    <?php
    if(isset($_POST['spq1'])){
        $answer = $_POST['spq1'];
        if((strcmp($answer, "What is Pizza?"))==0){
