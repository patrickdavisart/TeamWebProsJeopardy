...
<div>
    <fieldset>
        ...
        <p>Plastic Man's Secret Identity.</p><br><br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">

            <label for="DC4">Choose your answer:</label><br><br>
            <input type="submit" name="dc4" id="DC4" value="Who is Patrick O' Brien?">
            <input type="submit" name="dc4" id="DC4" value="Who is Ray Palmer?">
            <input type="submit" name="dc4" id="DC4" value="Who is J'onn J'onnz?">
            <input type="submit" name="dc4" id="DC4" value="Who is Ralph Dibny?">
            <br><br>
        </form>
        <?php
        if(isset($_POST['dc4'])){
            ...
            if((strcmp($answer, "Who is Patrick O' Brien?"))==0){
